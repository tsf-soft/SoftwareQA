...
Поскольку задача учебная, никакого ТЗ в моём случае не было, то для ознакомления со структурой и спецификой сайта (его функциональностью) для целей дальнейшего тестирования, пришлось составить "интеллект-карту" сайта. Результат выполнения этогого шага показан на рисунке 1.1 ниже.
...
Этот раздел также относится к функциональному тестированию. Здесь продемонстрировано применение методики попарного тестирования входных данных к объекту тестирования - интернет-порталу "насыщенных путешествий" https://youtravel.me/. 
