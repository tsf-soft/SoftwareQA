...
_<p>Таблицы 4.3. Тест-кейсы для проверки авторизации на сайте через email</p>_

<br/>

## 5. Фаза: "Тестирование поиска на сайте"

На этом этапе производилось тестирование поиска по сайту. Поскольку ТЗ нет, то были пременены общеприменимые методики (эвристики) с использованием таких вариантов запросов, как например: сокращения слов, английский регистр, словосочетания, регистры ввода и т.д. Результаты тестирования представлены в таблице 5.1. ниже.
