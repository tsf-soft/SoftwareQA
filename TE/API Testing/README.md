...
В этом разделе я кратко демонстирую пример интеграционного тестирования, а именно умение тестировать API приложений с использованием инструмента Postman.
...
_<p>Рисунок-1. Скриншот Postman-клиента с открытым тестом наличия пользователя</p>_
